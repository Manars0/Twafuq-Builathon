...
const options = [
  {
    ...
    description: 'Longer-term internships integrated with academic programs',
  ...
  },
  {
    ...
    icon: Grid,
    title: 'No Preference',
    description: 'Accept candidates looking for any internship type',
    gradient: 'from-teal-600 to-cyan-600',
  },
];

export function CompanyInternshipTypeSelection() {
      ...
      <div className="w-full max-w-3xl">
        ...
        >
          ...
          <h1 className="text-gray-900 text-3xl mb-3" style={{ fontWeight: 800 }}>
            What type of internship are you offering?
          </h1>
          <p className="text-gray-500 text-lg mb-2">
            Help us find the right candidates for your needs
          </p>
